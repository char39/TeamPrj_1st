...
public static class LevelDataList
{
    ...
    static LevelDataList()
    {
        levelData = new Dictionary<int, LevelData>()
        {
            ...
            {301, new LevelData(0, 10000, 12500, new List<int>{ 0, 2, 0 })},
            {302, new LevelData(0, 20000, 30000, new List<int>{ 2, 0, 1, 2 })},
            ...
            {307, new LevelData(0, 25000, 30000, new List<int>{ 1, 2, 2, 1, 1})},
        };
        ...
        levelSize = new Dictionary<int, LevelRoomSize>()
        {
            ...
            {302, new LevelRoomSize(33, -33, -50, 50)},
            ...
            {307, new LevelRoomSize(44, -44, -76, 76)},
        };
    }
}